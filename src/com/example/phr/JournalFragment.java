...
public class JournalFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
    	...
    	mDailyJournalList = (ListView)rootView.findViewById(R.id.listView_daily_journal);
    	mJournalTabsPlaceholder = (LinearLayout)rootView.findViewById(R.id.journalTabsPlaceholder);
    	...
    	journalAdapter = new JournalAdapter(this.getActivity().getApplicationContext(), list);
